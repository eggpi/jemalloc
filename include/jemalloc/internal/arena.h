...
void	*arena_chunk_alloc_huge(arena_t *arena, size_t usize, size_t psize,
...
void	arena_chunk_ralloc_huge_similar(arena_t *arena, void *chunk,
    size_t oldusize, size_t oldpsize, size_t usize, size_t psize);
void	arena_chunk_ralloc_huge_shrink(arena_t *arena, void *chunk,
    size_t oldusize, size_t oldpsize, size_t usize, size_t psize);
bool	arena_chunk_ralloc_huge_expand(arena_t *arena, void *chunk,
    size_t oldusize, size_t oldpsize, size_t usize, size_t psize, bool *zero);
